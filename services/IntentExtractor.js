...
const aiClient = require('./gemini-client.service');
...
Return ONLY a JSON object:
{
  ...
  "nationality": ["Indian", "Filipino"] | null,
  "lookalikeExamples": [{"name":"string","title":"string","company":"string","industry":"string","location":"string"}] | null,
...
JSON response:`;
      const responseText = await aiClient.generateContent(prompt, { maxTokens: 512 });
